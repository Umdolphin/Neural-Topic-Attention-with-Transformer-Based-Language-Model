...
MRD_ENTM = pd.DataFrame(columns = ['Num_Topic','AUC','Precision','Recall','F1','random_seed','Time'])
...
class Topic_Paper_ELECTRAClassifier(nn.Module):
    def __init__(self, ELECTRA, reduced_vocab_size=2000, num_topic=50, num_classes=3, pretrained_embed=None,
...
MRD_ENTM = MRD_ENTM.append({'Num_Topic' : num_topic,
