...
# Make storage
YELP_ENTM = pd.DataFrame(columns = ['Num_Topic','AUC','Precision','Recall','F1','random_seed','Time'])
...
class CustomDataset(Dataset):
    def __init__(self, dataset, sent_idx, label_idx, bert_tokenizer, max_len, pad, pair):
        self.sentences = [
            bert_tokenizer(
                text, padding='max_length', return_tensors="pt", max_length=max_len, truncation=True
...
class Topic_Paper_ELECTRAClassifier(nn.Module):
    ...
    def __init__(self, ELECTRA, reduced_vocab_size=2000, num_topic=50, num_classes=5, pretrained_embed=None,
...
YELP_ENTM = YELP_ENTM.append({'Num_Topic' : num_topic,
