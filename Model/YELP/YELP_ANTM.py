...
# Make storage
YELP_ANTM = pd.DataFrame(columns = ['Num_Topic','AUC','Precision','Recall','F1','random_seed','Time'])
...
class Topic_Paper_AlbertClassifier(nn.Module):
    ...
    def __init__(self, Albert, reduced_vocab_size=2000, num_topic=50, num_classes=5, pretrained_embed=None,
...
def accuracy(X,Y):
    ...
    # batch_size = 16,dr_rate = 0.5, Adamw,cliping = 1, max_len = 256
...
YELP_ANTM = YELP_ANTM.append({'Num_Topic' : num_topic,
