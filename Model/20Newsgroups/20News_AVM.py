...
# Make storage
News_AVM = pd.DataFrame(columns = ['Num_Topic','AUC','Precision','Recall','F1','random_seed','Time'])
...
class AlbertClassifier(nn.Module):
    def __init__(self, Albert, hidden_size=768, num_classes=20, dr_rate=None, params=None):
        ...
        # Uncomment if weight initialization is needed
...
print(end)
print('Final ACC : {} Final precision {} Final Recall {} Final F1 : {}'.format(
    np.mean(test_acc_L),
...
print('Fianl ACC : {} Final precision {} Final Recall {} Final F1 : {}'.format(np.mean(test_acc_L),
                                                                                   ...
                                                                                   np.mean(test_recall_L),
                                                                                   np.mean(test_f1_score)))
News_AVM = News_AVM.append({'Num_Topic' : num_topic,
